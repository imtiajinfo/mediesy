...
<div class="row">
    <div class="card p-0">
        <div class="card-header justify-content-between py-3">
            <h4 class="card-title float-left pt-2">Edit Brand</h4>
        </div>
        <!-- /.card-header -->
            ...
            <form method="POST" action="{{ route('admin.brands.update', $brand->id) }}" enctype="multipart/form-data">
                ...
                <div class="row justify-content-center">
                    <div class="mb-3 col-md-5 col-lg-5">
                        ...
                        <input class="form-control" type="text" name="name_english" placeholder="brand Name English..." value="{{$brand->name_english}}">
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="mb-3 col-md-5 col-lg-5">
                        <img src="{{ $brand->logo ? asset('uploads/brand/' . $brand->logo) : asset('uploads/brand/default.png') }}" alt="default.jpg" width="60px"><br>
