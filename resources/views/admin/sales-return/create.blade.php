        ...
        <div class="container p-4 pt-0 pb-0">
            ...
            <div class="row">
                <div class="card mt-2 pt-1 mb-3 pb-3">
                    ...
                    <form method="POST" action="{{ route('admin.sales-return.store') }}" enctype="multipart/form-data" id="return-form">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="id" value="{{$sale_return->id}}">
                            <input type="hidden" name="customer_id" value="{{@$sale_return->customer->id??'0'}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mr-2">
                                    <select disabled name="customer_id"
                                        ...
                                        <option value="{{@$sale_return->customer->id??'0'}}">{{@$sale_return->customer->name??"Guest"}}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <input type="date" class="form-control" id="po_date" value="{{date('Y-m-d', strtotime(($sale_return->po_date)))}}" name="sell_date" disabled>
                            </div>

                            <div class="mb-3 col-md-3">
                                <div class="form-group">
                                    <label for="purchased_by">Sell By</label>
                            ...
                            <table class="table table-sm">
                                <thead>
                                    <tr class="bg-light">
                                        ...
                                        <th class="text-start">Av.Sell Qty</th>
                                        <th class="text-start">Return Qty</th>
                                        <th class="text-start">Total</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @if (!empty($sale_return->sellsItems))
                                        
                                        @foreach ($sale_return->sellsItems as $key => $child)

                                            <input name="product_ids[]" value="{{ $child->itemInfo->id}}" type="hidden">
                                            <input name="child_id[]" value="{{ $child->id}}" type="hidden">
                                            <input name="purchase_price[]" value="{{ $child->sell_price - $child->discount_amount}}" type="hidden">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 12%"><input name="purchase_price[]" type="text" class="form-control" value="{{ $child->sell_price - $child->discount_amount }}" disabled>
                                                <td style="width: 10%"><input name="purchase_qty[]" type="text" class="form-control" value="{{ $child->quantity - $child->return_qty}}" disabled>
                                                </td>
                                                ...
                                                <td style="width: 15%"><input name="sub_total[]" type="text" class="form-control sub_total" value="00.00" disabled></td>
                                            </tr>
                                        @endforeach
