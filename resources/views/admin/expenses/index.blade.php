  ...
  <div class="row my-auto align-items-center bg-white shadow-md border mb-3 py-2">
      <div class="col-sm-6">
          ...
          <ol class="breadcrumb bg-white">
              ...
              <li class="breadcrumb-item text-dark px-2"><a href="{{ route('admin.expenses.index') }}"> Expense</a>
              </li>
          </ol>
      </div>
      <div class="col-md-6">
          <ol class="float-right button">
              <a href="{{ route('admin.expenses.create') }}" class="btn btn-success" rel="tooltip" id="add" title="add">
                  Add New Expense
              </a>
          </ol>
      </div>
                      ...
                      <tbody id="datatable">
                          ...
                          <tr>
                              ...
                              {{-- <td>
                                  ...
                                  @endphp
                                  <span class="{{ $badgeClass }}">{{ ($data->status == '1') ? 'Active' : 'In-Active'}}</span>
                              </td> --}}
                              <td style="min-width:130px;text-align:center" class="my-4 text-center">
                                  <a href="{{ route('admin.expenses.edit', $data->id) }}" class="btn btn-primary btn-sm edit text-light border-0 edit" rel="tooltip" id="edit" title="Edit" data-id="4">
                                      <i class="fa-regular fa-pen-to-square"></i>
                                  </a>
                                  {{-- <a href="{{ route('admin.expenses.show', $data->id) }}" class="btn btn-info btn-sm text-light view border-0 view" id="view" rel="tooltip" title="view">
                                      <i class="fas fa-eye"></i>
                                  </a> --}}
                                  <form action="{{ route('admin.expenses.destroy', $data->id) }}" method="POST" style="display: inline;">
                                      @csrf
                                      @method('DELETE')
