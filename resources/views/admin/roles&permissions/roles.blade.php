...
<li class="breadcrumb-item text-dark"><a href="{{route('admin.brands.index')}}">roles</a></li>
@endsection
    ...
    <div class="col-12 p-0">
        <div class="card">
            <div class="card-header justify-content-between py-3">
                <h4 class="card-title float-left pt-2">All Roles</h4>
            ...
            <!-- /.card-header -->
            <div class="card-body card-body table-reponsive p-0">
                <table id="example1" class="table table-hover">
                    <thead>
                        <tr>
                            <th>SL</th>
                            <th>roles Name</th>
                            <th>roles Name Bangla</th>
                            <th>Menu</th>
                    ...
                    <tbody id="datatable">
                        <tr>
                            ...
                            <td>Manager</td>
                            <td>Manager</td>
                            <td>product list, Assign Product, Sells return</td>
                            <td>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">Add New roles</h1>
                    ...
                    <div class="modal-body px-md-4">
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" name="HID-date" placeholder="roles Name English..." value="">
                            </div>
                            <div class="mb-3 col-md-6">
                                <label>roles Name Bangla</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="roles Name bangla..." value="">
                            </div>
        ...
        <div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">Edit roles</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body px-md-4">
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <label>roles Name</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="roles Name English..." value="Manager Water">
                            </div>
                            <div class="mb-3 col-md-6">
                                <label>roles Name Bangla</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="roles Name bangla..." value="Manager Water">
                            </div>
        ...
        <div class="modal fade" id="viewModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">View roles</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body px-md-4">
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <label>roles Name</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="roles Name English..." value="Manager Water" disabled>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label>roles Name Bangla</label>
                                <input class="form-control" type="text" name="HID-date" placeholder="roles Name bangla..." value="Manager Water" disabled>
                            </div>
