...
<div class="row">
    <div class="card bg-white p-0">
        <div class="card-header justify-content-between py-3">
            <h4 class="card-title float-left pt-2">Create New Supplier</h4>
        </div>
                ...
                <div class="row">
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="company_name" class="form-control @error('company_name') is-invalid @enderror" placeholder="Enter Company Name" id="company_name" value="{{ old('company_name') }}" required>
                            @error('company_name')
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Company Owner" id="name" value="{{ old('name') }}">
                            @error('name')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="company_tin_number" class="form-control @error('company_tin_number') is-invalid @enderror" placeholder="Enter Tax No" id="company_tin_number" value="{{ old('company_tin_number') }}">
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="supplier_destination" class="form-control @error('supplier_destination') is-invalid @enderror" placeholder="Enter Supplier Address..." id="supplier_destination" value="{{ old('supplier_destination') }}">
