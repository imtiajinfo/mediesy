    ...
    <div class="col-12 p-0">
        <div class="card">
            <div class="card-header justify-content-between py-3">
                <h4 class="card-title float-left pt-2">Supplier List</h4>
                ...
                <div class="float-right d-flex my-auto gap-3">
                    ...
                    <form class="mb-0 pb-0" id="sort_suppliers" action="" method="GET">
                        <div class="input-group py-0 my-0">
                            <input type="text" name="search" class="form-control" id="inputGroupFile02" placeholder="Search by Compnay Name, Email, Phone, Supplier Name.." value="{{$search}}">
                ...
                <table id="example1" class="table table-hover">
                    ...
                    <tbody id="datatable">
                        ...
                        <tr>
                            ...
                            <td>{{ $supplier->supplier_destination }}</td>
                            <td>{{ $supplier->email }}</td>
                            <td>{{ $supplier->phone }}</td>


                            <td>{{ $supplier->company_tin_number }}</td>
                            <td>{{ $supplier->brand }}</td>


                            <td style="min-width:130px" class="d-flex my-4 text-center">
                                <a href="{{ route('admin.suppliers.edit', $supplier->id) }}" class="btn btn-primary btn-sm edit text-light border-0 edit" rel="tooltip" id="edit" title="Edit" data-id="4">
