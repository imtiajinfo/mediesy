    ...
    <div class="col-12 p-0">
        <div class="card">
            <div class="card-header justify-content-between py-3">
                <h4 class="card-title float-left pt-2">Purchase Orders List</h4>
                ...
                <div class="float-right d-flex my-auto gap-3">
                    ...
                    <form class="mb-0 pb-0" id="sort_purchaseOrders" action="" method="GET">
                        <div class="input-group py-0 my-0">
                            <input type="text" name="search" class="form-control" id="inputGroupFile02" placeholder="Search by Supplier, Invoice No, Amount" value="{{@$search}}">
                ...
                <table id="example1" class="table table-hover">
                    ...
                    <tbody id="datatable">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.purchase-orders.edit', $purchaseOrder->id) }}" class="btn btn-primary btn-sm edit text-light border-0 edit" rel="tooltip" id="edit" title="Edit" >
