...
<div class="row my-auto align-items-center bg-white shadow-md border mb-3 py-2">
    <div class="col-sm-6">
        ...
        <ol class="breadcrumb bg-white">
            ...
            <li class="breadcrumb-purchaseOrder text-dark px-2"><a href="{{ route('admin.purchase-orders.index') }}">Purchase Return</a> </li>
        </ol>
    </div>
    <div class="col-md-6">
        <ol class="float-right button">
            <a href="{{ route('admin.purchase-return.create') }}" class="btn btn-success" rel="tooltip" id="add" title="add">
                Add New Return
            </a>
        </ol>
    </div>
    ...
    <div class="col-12 p-0">
        <div class="card">
            <div class="card-header justify-content-between py-3">
                <h4 class="card-title float-left pt-2">Purchase Return List</h4>
                    ...
                    <tbody id="datatable">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.purchase-return.show', $item->id) }}" class="btn btn-info btn-sm text-light view border-0 view" id="view" rel="tooltip" title="view">
