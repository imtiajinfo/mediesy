...
@section('title', 'Admin | Payment to Supplier')
...
<li class="breadcrumb-item text-dark"><a href="{{route('admin.brand')}}">Payment to Supplier</a></li>
@endsection
    ...
    <div class="col-12 p-0">
        <div class="card">
            <div class="card-header justify-content-between py-3">
                <h4 class="card-title float-left pt-2">Payment to Supplier</h4>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">Payment to Supplier</h1>
                            ...
                            <div class="mb-3 col-md-4 col-lg-3">
                                ...
                                <div class="form-group mb-0">
                                    <select id="mySelect" class="selectpicker w-100">
                                        ...
                                        <option selected>Mokka Group Ltd.</option>
                                        <option>Modina Group Ltd.</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <table class="table mt-4 aiz-table table-bordered">
                                <thead>
                                    <tr class="bg-light my-auto">
                                        ...
                                        <th class="text-left">Purchase Order Id</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-left">CHL-9282</td>
                                        <td class="text-left">SPO-282</td>
