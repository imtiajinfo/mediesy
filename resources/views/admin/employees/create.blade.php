...
<div class="row">
    <div class="card bg-white p-0">
        <div class="card-header justify-content-between py-3">
            <h4 class="card-title float-left pt-2">Create New employee</h4>
        </div>
                ...
                <div class="row">
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter employee Name..." id="name" value="{{ old('name') }}" required>
                            @error('name')
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Enter password..." id="password" value="{{ old('password') }}" required>
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <select name="store_id" class="form-select @error('store_id') is-invalid @enderror" placeholder="" id="store_id">
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="salary" class="form-control @error('salary') is-invalid @enderror" placeholder="Enter salary..." id="salary" value="{{ old('salary') }}" required>
                            @error('salary')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
...
<div class="mb-3 col-md-4 col-lg-3">
    <div class="form-group">
        ...
        <textarea name="reference_details" class="form-control @error('reference_details') is-invalid @enderror" placeholder="Enter reference_details..." id="reference_details">{{ old('reference_details') }}</textarea>
