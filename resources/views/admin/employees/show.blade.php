...
<div class="row">
    <div class="card bg-white p-0">
        <div class="card-header justify-content-between py-3">
            <h4 class="card-title float-left pt-2">View Employee</h4>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="phone" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Enter phone..." id="phone" value="{{ old('phone', $employee->phone) }}" disabled>
                            @error('phone')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Enter Email..." id="email" value="{{ old('email',$employee->email) }}" disabled>
                            @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Enter password..." id="password" value="{{ old('password',$employee->password) }}" disabled>
                            @error('password')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <select name="store_id" class="form-select @error('store_id') is-invalid @enderror" id="store_id">
                                ...
                                <option value="{{ $store->id }}" {{ (old('store_id') == $store->id || $store->id == $employee->store_id) ? 'selected' : '' }} disabled readonly>
                                    {{ $store->name }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="salary" class="form-control @error('salary') is-invalid @enderror" placeholder="Enter salary..." id="salary" value="{{ $employee->salary  }}" disabled>
                            @error('salary')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <textarea name="reference_details" class="form-control @error('reference_details') is-invalid @enderror" placeholder="Enter reference_details..." id="reference_details" readonly disabled>{{ $employee->reference_details  }}</textarea>
                    ...
                    <div class="mb-3 text-right">
                        <a type="button" class="btn bg-danger" href="{{ route('admin.employees.index') }}">Close</a>
                    </div>
                </div>
            </form>
