...
@section('title', 'Admin | hand-over-product-to-sales-man')
...
<li class="breadcrumb-item text-dark"><a href="{{route('admin.brand')}}">Hand Over Product To Sales Man</a></li>
    ...
    <div class="col-12 p-0">
        <div class="card">
            <div class="card-header justify-content-between py-3">
                <h4 class="card-title float-left pt-2"> List Of Product for Hand Over To Sales Man</h4>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body px-md-4">
                        ...
                        <div class="mb-3 text-right">
                            ...
                            <button type="button" class="btn btn-warning">Hand Over</button>
                        </div>
                    </div>
                </div>
            </div>
