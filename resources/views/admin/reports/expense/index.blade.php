...
@section('title', 'Admin | Expense Report')
    ...
    <div class="row my-auto align-items-center bg-white shadow-md border no-print">
        <div class="col-sm-6">
            ...
            <ol class="breadcrumb bg-white p-2 m-2">
                ...
                <li class="breadcrumb-item text-dark"><a href="{{ route('admin.reports.expense') }}">Expense Report</a>
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="card bg-white">
            ...
            <div class="card-header bg-light no-print">
                <form action="{{ route('admin.reports.expense') }}" method="get">
            ...
            <div class="container">
                ...
                @include('admin.reports.print_header', ['report_name' => 'Expense Report'])
