  ...
  <div class="row my-auto align-items-center bg-white shadow-md border mb-3 py-2">
      <div class="col-sm-6">
          ...
          <ol class="breadcrumb bg-white">
              ...
              <li class="breadcrumb-item text-dark px-2"><a href="{{ route('admin.sizes.index') }}"> Size</a>
              </li>
          </ol>
      </div>
      <div class="col-md-6">
          <ol class="float-right button">
              <a href="{{ route('admin.sizes.create') }}" class="btn btn-success" rel="tooltip" id="add" title="add">
                  Add New Size
              </a>
          </ol>
      </div>
      ...
      <div class="col-12 p-0">
          <div class="card">
              <div class="card-header justify-content-between py-3">
                  <h4 class="card-title float-left pt-2">All Size</h4>

                  <div class="float-right d-flex my-auto gap-3">

                      <form class="mb-0 pb-0" id="sort_sizes" action="" method="GET">
                  ...
                  <table id="example1" class="table table-hover">
                      <thead>
                          <tr>
                              ...
                              {{-- <th>Description</th> --}}
                              <th>Status</th>
                              <th class=" text-end mr-0">Actions</th>
                          </tr>
                      </thead>
                      <tbody id="datatable">
                          @if (count($query) > 0)
                          ...
                          <tr>
                              ...
                              <td style="min-width:130px" class="d-flex my-4 text-end float-md-right">
                                  <a href="{{ route('admin.sizes.edit', $data->id) }}" class="btn btn-primary btn-sm edit text-light border-0 edit" rel="tooltip" id="edit" title="Edit" data-id="4">
                                      <i class="fa-regular fa-pen-to-square"></i>
                                  </a>
                                  <a href="{{ route('admin.sizes.show', $data->id) }}" class="btn btn-info btn-sm text-light view border-0 view" id="view" rel="tooltip" title="view">
                                      <i class="fas fa-eye"></i>
                                  </a>
                                  <form action="{{ route('admin.sizes.destroy', $data->id) }}" method="POST" style="display: inline;">
                                      @csrf
                                      @method('DELETE')
