 ...
 <div class="row">
     <div class="card bg-white p-0">
         <div class="card-header justify-content-between py-3">
             <h4 class="card-title float-left pt-2">View Size</h4>
         </div>
                 ...
                 <div class="row">
                     ...
                     <div class="mb-3 col-12 col-md-4 col-lg-3">
                         <div class="form-group">
                             <label for="name">Name</label><input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Name..." id="name" value="{{ old('name', optional($query)->name) }}" placeholder="Enter name..." required disabled>@error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                         </div>
                     </div>
                     <div class="mb-3 col-12 col-md-4 col-lg-3">
                         <div class="form-group">
                     ...
                     <div class="mb-3 col-12 col-md-4 col-lg-3">
                         <div class="form-group">
                             <label for="size">Size</label><input type="number" step="any" name="size" class="form-control @error('size') is-invalid @enderror" placeholder="Enter Size..." id="size" value="{{ old('size', optional($query)->size) }}" placeholder="Enter size..." required disabled>@error('size')<div class="invalid-feedback">{{ $message }}</div>@enderror
                         </div>
                     </div>
                     <div class="mb-3 col-12 col-md-4 col-lg-3">
                         <div class="form-group">
                     ...
                     <div class="mb-3 text-right">
                         <a type="button" class="btn bg-danger" href="{{ route('admin.sizes.index') }}">Close</a>
                     </div>
                 </div>
             </form>
         </div>
