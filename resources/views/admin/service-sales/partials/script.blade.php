<script>
        ...
        axios
            ...
            .then(async (response) => {
              ...
              item.data.min_qty
                                    ...
                                    <input type="hidden" name="discount" class="product_discount" value="${
                                      item.data.discount_amount
                                    }"></input>
                                    <input type="hidden" class="product_tax_amount" value="${
                                      item.data.tax_amount
                                    }"></input>
                                    <input type="hidden" class="total_amount" name="product_total_amount" value="${
    ...
    function updateTotalAmount(row) {
        ...
        var discount_amount = parseFloat(
            row.querySelector(".product_discount").value
        );
    ...
    function updateSummary() {
        ...
        document.querySelectorAll("#itemTableBody tr").forEach(function(row, index) {
            const totalAmount =
                parseFloat(row.querySelector(".total_amount").value) || 0;
        ...
        grandTotal = subtotal + other_charges_amt;
        ...
        document.getElementById("total_product_qty").textContent =
            total_qty.toFixed(2);
        // Update the grand total in the summary table
...
<script>
    ...
    document.getElementById('customerFrom').addEventListener('submit', function(event) {
