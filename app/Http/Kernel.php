...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\CheckAdmin::class,          // \Illuminate\Session\Middleware\AuthenticateSession::class,
    ...
    protected $routeMiddleware = [
        ...
        // 'auth:api' => \App\Http\Middleware\CheckAdmin::class . ':admin', 
        'auth:api' => \App\Http\Middleware\AuthenticateApi::class,

        'cors' => \App\Http\Middleware\CorsMiddleware::class,
        // 'routePermission' => \App\Http\Middleware\CheckPermissions::class,
    ];
}
